...
<div class="px-3 py-12">
      <div
        class="lg:max-w-[1280px] md:max-w-[696px] max-w-[343px] mx-auto bg-white lg:px-20 md:px-6 px-4 py-12"
      >
        <div uk-scrollspy-class="uk-animation-slide-top" class="lg:flex md:flex block">
          <div class="flex">
            <div class="bg-gray-800 max-w-[66px] w-full">
              <p
                class="xl:text-2xl lg:text-base font-semibold leading-normal text-white -rotate-90 whitespace-nowrap 2xl:mt-32 xl:mt-[130px] lg:mt-[140%] md:mt-[85px] mt-28"
              >
                Upto 50% Off
              </p>
            </div>
          ...
          <div>
            ...
            />
            <img
              src="https://tuk-cdn.s3.amazonaws.com/can-uploader/fff.png"
              alt="img"
              class="lg:hidden md:block hidden"
            />
          </div>
          <div
            class="bg-gray-800 lg:py-2 md:py-2 py-4 lg:px-5 md:px-4 px-3 flex flex-col items-center justify-center"
          >
            <p
              class="lg:text-4xl md:text-2xl text-2xl font-semibold text-center text-white"
            >
              Modern Fashion
            </p>
            <p class="text-xs text-center text-white pt-4">
              Shop enchanting designs with bold and classy colors at discunted
              price
            </p>
          </div>
          ...
          <div>
            <img
              ...
              alt="sandles"
              class="lg:block md:hidden block"
            />
            <img
...
<div tabindex="0" class="focus:outline-none">
            ...
            <div class="mx-auto container py-8">
                <div uk-scrollspy="target: > div; cls: uk-animation-fade; delay: 100" class="flex  flex-wrap items-center lg:justify-between justify-center">
                    <!-- Card 1 -->
                    <div tabindex="0" class="focus:outline-none cardp mx-2 w-72 xl:mb-0 mb-8">
